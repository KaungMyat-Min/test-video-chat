...
class VideoActivity : AppCompatActivity() {
    ...
    private val enableAutomaticSubscription: Boolean
        get() {
            return sharedPreferences.getBoolean(
                Constants.PREF_ENABLE_AUTOMATIC_SUBSCRIPTION,
                Constants.PREF_ENABLE_AUTOMATIC_SUBCRIPTION_DEFAULT
            )
        }
    ...
    private val encodingParameters: EncodingParameters
        get() {
            val defaultMaxAudioBitrate = Constants.PREF_SENDER_MAX_AUDIO_BITRATE_DEFAULT
            val defaultMaxVideoBitrate = Constants.PREF_SENDER_MAX_VIDEO_BITRATE_DEFAULT
    ...
    private val sharedPreferences by lazy {
        getSharedPreferences("default_pref", Context.MODE_PRIVATE)
    }
